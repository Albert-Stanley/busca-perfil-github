...
export default function GitHubProfileLayout() {
  return (
    <div className="relative w-full h-screen bg-[#1f1f1f] overflow-hidden flex justify-center items-center">
      ...
      <div className="z-10 bg-black w-[90%] max-w-[1156px] h-[80%] max-h-[537px] rounded-lg p-6 md:p-8 shadow-xl flex flex-col justify-center items-center">
        <p className="text-gray-400 text-xl text-center">Aguardando busca...</p>
      </div>
    </div>
  );
}
